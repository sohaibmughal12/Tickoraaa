...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (res.success) {
      toast.success('Registration successful. Welcome to Tickora!');
    } else {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-20 text-white flex flex-col justify-center">
      ...
      <div className="text-center space-y-3 mb-10">
        <h1 className="text-3xl sm:text-4xl font-playfair uppercase tracking-wider text-white">Sign Up</h1>
        <p className="text-xs uppercase tracking-widest text-luxury-gold">Create your Tickora account</p>
      ...
      <GlassCard className="p-8">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-1">
            <label htmlFor="name" className="block text-xs uppercase tracking-widest text-gray-500 font-semibold">Full Name</label>
            <div className="relative">
              ...
              />
              <FiUser className="absolute left-3 top-3.5 text-gray-500" size={14} />
            </div>
        ...
        <div className="mt-8 text-center text-xs text-gray-500 font-light pt-6 border-t border-white/5">
          <span>Already have a private account? </span>
          <Link to="/login" className="text-luxury-gold hover:underline font-semibold uppercase tracking-widest text-[10px] ml-1">
            Sign In
          </Link>
        </div>
      </GlassCard>
